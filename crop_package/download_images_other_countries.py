...
# MOD09A1. (8-day surface spectral reflectance of bands 1 and 2 at 500m resolution)
...
def load_all(country_code='SSD', date_range=('2010-01-01', '2022-01-01'), modis_collection='006/MYD11A2', num_pixels=1000):
    lower_case_country_code = country_code.lower
    states_shp = f'../raw_data/USA/admin1/USA.shp'

    for state_name in state_names[11:]:

        list_df = []
        for start_year in range(2002, 2022):
