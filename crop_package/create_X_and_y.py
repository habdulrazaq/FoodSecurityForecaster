...
# 4. import feature/X (23 images/columns=1yr and 32 rows/bins)
X_2010 = np.random.uniform(0, 9000, (23, 32))
X_2011 = np.random.uniform(0, 9000, (23, 32))
X_2012 = np.random.uniform(0, 9000, (23, 32))
X_2013 = np.random.uniform(0, 9000, (23, 32))
X_2014 = np.random.uniform(0, 9000, (23, 32))
X_2015 = np.random.uniform(0, 9000, (23, 32))
X_2016 = np.random.uniform(0, 9000, (23, 32))
X_2017 = np.random.uniform(0, 9000, (23, 32))
print(X_2010)
